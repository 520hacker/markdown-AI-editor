...
import { queryChatList, queryChatContentList, makeTextFileLineIterator } from "../api/openAI";
...
const handleEnter = async () => {
  ...
  try {
    ...
    if (curChat.value.short_cut_id) {
      console.log("curChat.value.short_cut_id" + curChat.value.short_cut_id)
    ...
    var url = "/echo/openai/chatCompletion";
    var params = {
      prompt,
      content,
...
<template>
  <div id="echo-main-window-root" class="main-window mode-sidebar" style="width: 420px; max-width: 100%; height: 100vh">
    <header class="header">
      <div class="header-left">
        <a class="logo-wrapper" target="_blank" rel="noreferrer"><img :src="icon" class="logo logo-img"
            style="width: 22px; height: 22px; border-radius: 4px" /><span class="title">AI
            {{ `${curChat && curChat.title ? "-" + curChat.title : ""}` }}</span></a>
      </div>
      ...
      <div class="chat chat_light">
        <div class="chat-box">
          <div class="wrapper">
            <div class="chat-container" style="padding-bottom: 60px">
              <template v-for="item in chatContentList" :key="item._id">
                ...
                <div class="chat-item chat-reply" v-if="item.item_type === 'reply' && item.content">
                  <div class="feedback message-content-wrap">
                    <div class="chat-content markdown-body gpt-markdown">
                      <div class="markdown __markdown light markdown-body">
                        ...
                        <div class="operate-bar">
                          <span title="复制内容" v-if="item.content && !showCopySuccess" v-clipboard:copy="item.content"
              ...
              <div class="chat-suggestion" v-if="!curChat || !curChat.short_cut_id">
                <div class="suggestion-bar">
                  <div class="suggestion-item" v-for="(item, key) in suggestions" :key="key"
          ...
          <div class="input-panel">
            <div class="toolbar">
              <div class="lt">
                <div class="btn echo-btn toolbar-btn primary-button small-button" style="font-weight: normal"
                  @click="handleNewChat">
                  <IPlus :width="14" :height="14"></IPlus><span>新会话</span>
                </div>
                <div class="btn echo-btn toolbar-btn outline primary-outline-button small-button"
                  style="font-weight: normal" @click="showHistoryDrawer">
              ...
              <div class="input">
                <div class="input-container">
                  <div class="input-msg-content">
                    <div class="textarea">
                      <div class="mirror-node" style="max-height: 100px; min-height: 32px">
                        <span></span>
                      </div>
                      <textarea placeholder="问我任何问题..." @keypress.enter="handleEnter"
    ...
    <div class="drawer" :class="{ show: historyVisible }" style="height: 80%; max-height: 680px">
      <div class="drawer-header">
        ...
        <IClose class="drawer-close" width="24" height="24" @click="historyVisible = false"></IClose>
      </div>
          ...
          <div class="conv-list">
            <div>
              <div class="conv-item-wrapper">
                <div class="conv-item" v-for="item in historys" :key="item._id" @click="handleChangeChat(item)">
